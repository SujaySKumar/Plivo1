This is a rudimentary Android application that uses the Plivo API in order to place a call from a predetermined number to the phone number specified by the user.
